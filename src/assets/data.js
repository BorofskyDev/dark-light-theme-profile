export default [
  {
    ...
    imageUrl: './project-images/blog.png',
  },
  {
    id: 1,
    title: 'Nextjs Blog with Tailwind',
    ...
    liveSite:
      'https://nextjs-blog-tailwind-qhttl1i3q-joelborofskydev-gmailcom.vercel.app/',
    description:
      'A blog completed using TailwindCSS, Hygraph, and Nextjs as the framework. Using Nextjs, I was able to optimize performance as well as enhance the SEO. Likewise, I made the blog more accessibly by using an offwhite/light-gray instead of a bright white, allowing those with light sensitivity to read the blog with greater ease. Finally, using Hygraph as the CMS, I was able to use their custom API playground to create a seamless transition on both the API call and the API push for the comments.',
    imageUrl: './project-images/blog.png',
  },
  {
    id: 2,
    ...
    imageUrl: './project-images/uptown-landing.png',
  },
  {
    id: 3,
    title: 'Club Bacchus',
    ...
    imageUrl: './project-images/bacchus.png',
  },
  {
    id: 4,
    ...
    imageUrl: './project-images/portfolio-card2.png',
  },
  {
    id: 5,
    ...
    imageUrl: './project-images/recipe-creator.png',
  },
  {
    id: 6,
    title: 'Tab Portfolio',
    ...
    imageUrl: './project-images/portfolio-card.png',
  },
]
